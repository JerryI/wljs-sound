...
export { AMOscillator, AmplitudeEnvelope, AudioToGain, BaseContext, Channel, Clock, Context, Emitter, Envelope, FMOscillator, FatOscillator, FrequencyClass, Gain, IntervalTimeline, MembraneSynth, Multiply, OfflineContext, OmniOscillator, Oscillator, PWMOscillator, PanVol, Panner, Param, Player, Pow, PulseOscillator, Sampler, Signal, Solo, StateTimeline, Synth, TicksClass, TimeClass, Timeline, ToneAudioBuffer, ToneAudioBuffers, ToneAudioNode, ToneBufferSource, ToneOscillatorNode, TransportTimeClass, Volume, WaveShaper, connect, connectSeries, connectSignal, dbToGain, defaultArg, disconnect, ftom, gainToDb, getContext, intervalToFrequencyRatio, isArray, isBoolean, isDefined, isFunction, isNote, isNumber, isObject, isString, isUndef, mtof, optionsFromArguments, setContext, version };
